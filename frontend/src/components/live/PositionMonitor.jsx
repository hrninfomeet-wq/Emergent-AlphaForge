...
import { AlertTriangle, Heart, Loader2, ShieldOff, Square, XOctagon } from "lucide-react";
 ...
 *
 * Only renders when there is an active session (status !== "none" / position present).
 * Shows:
 *   - Position summary
 *   - MM:SS live countdown from remaining_secs
 *   - Progress bar
 *   - Backend-heartbeat dot (green if heartbeat recent, amber if stale)
 *   - Square now button
 *   - Kill switch button
 */
