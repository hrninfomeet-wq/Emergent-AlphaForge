...
5. **NEXT:** Pre-flight data realism panel — before allowing a deployment to be created, show: spot coverage for the next 5 trading days estimate, option contracts present for relevant expiries, planner-coverage estimate, expiry-rule rotation notes, BANKNIFTY weekly discontinuation warning. Informational, does not block.
