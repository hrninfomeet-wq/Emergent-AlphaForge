...
9. **NEXT:** Acknowledgment checkbox on deployment creation when source backtest has worrying signs (walk-forward divergence > 30%, low trade count, etc.) — does NOT block, just forces conscious choice
