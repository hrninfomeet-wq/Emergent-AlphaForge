...
6. **NEXT:** Slippage model with configurable defaults — ATM 0.5pt, OTM1 1pt, OTM2+ 2pt, expiry-day-30min 2x multiplier; user override per backtest. Plus a post-hoc volatility detector (5min realized / 30day average; >2.5x triggers wide-spread flag) since reliable event calendar is not feasible.
